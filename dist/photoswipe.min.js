...
f.panTo(b,c)},toggleDesktopZoom:function(b){b=b||{x:pa.x/2+ra.x,y:pa.y/2+ra.y};var c=i.getDoubleTapZoom(!0,f.currItem),d=f.currItem.w>i.maxForceZoomSize?f.currItem.initialZoomLevel:f.currItem.w*i.maxForceZoomLevel>i.maxForceZoomSize?i.maxForceZoomSize/f.currItem.w:i.maxForceZoomLevel,g=s===c,h=1===f.currItem.initialZoomLevel,j=s>1&&h;f.mouseZoomedIn=!g,f.zoomTo(g?d:c,b,333),e[(!h&&!g||h&&!j?"add":"remove")+"Class"](a,"pswp--zoomed-in")}}});/*>>desktop-zoom*/
/*>>history*/
/**
 *
 * history.js:
