...
var f=this,g=25,h=3,i={allowPanToNext:!0,spacing:.12,bgOpacity:1,mouseUsed:!1,loop:!0,pinchToClose:!0,closeOnScroll:!0,closeOnVerticalDrag:!0,verticalDragRange:.75,hideAnimationDuration:333,showAnimationDuration:333,showHideOpacity:!1,focus:!0,escKey:!0,arrowKeys:!0,mainScrollEndFriction:.35,panEndFriction:.35,isClickableElement:function(a){return"A"===a.tagName},getDoubleTapZoom:function(a,b){return a?1:b.initialZoomLevel<1?1:i.maxForceZoomLevel},maxSpreadZoom:1.33,modal:!0,maxForceZoomSize:800,maxForceZoomLevel:2,
...
Ba("mouseUsed",function(){f.setupDesktopZoom()}):f.setupDesktopZoom(!0))},setupDesktopZoom:function(b){qc={};var c="wheel mousewheel DOMMouseScroll";Ba("bindEvents",function(){e.bind(a,c,f.handleMouseWheel)}),Ba("unbindEvents",function(){qc&&e.unbind(a,c,f.handleMouseWheel)}),f.mouseZoomedIn=!1;var d,g=function(){f.mouseZoomedIn&&(e.removeClass(a,"pswp--zoomed-in"),f.mouseZoomedIn=!1),e.addClass(a,"pswp--zoom-allowed"),h()},h=function(){d&&(e.removeClass(a,"pswp--dragging"),d=!1)};Ba("resize",g),Ba("afterChange",g),Ba("pointerDown",function(){f.mouseZoomedIn&&(d=!0,e.addClass(a,"pswp--dragging"))}),Ba("pointerUp",h),b||g()},handleMouseWheel:function(a){if(s<=f.currItem.fitRatio)
// close PhotoSwipe
...
f.panTo(b,c)},toggleDesktopZoom:function(b){b=b||{x:pa.x/2+ra.x,y:pa.y/2+ra.y};var c=f.currItem.initialZoomLevel,d=f.currItem.w*s,g=!0;f.currItem.w>i.maxForceZoomSize?d<=i.maxForceZoomSize&&(c=f.currItem.w/i.maxForceZoomSize,g=!1):f.currItem.w>=i.maxForceZoomSize/i.maxForceZoomLevel&&f.currItem.w<=i.maxForceZoomSize?Math.floor(d)!==i.maxForceZoomSize&&(c=i.maxForceZoomSize/f.currItem.w,g=!1):Math.floor(d)!==Math.floor(f.currItem.w*i.maxForceZoomLevel)&&(c=i.maxForceZoomLevel,g=!1);var h=1===f.currItem.initialZoomLevel,j=s>1&&h;f.mouseZoomedIn=!g,f.zoomTo(c,b,333),e[(!h&&!g||h&&!j?"add":"remove")+"Class"](a,"pswp--zoomed-in")}}});/*>>desktop-zoom*/
/*>>history*/
/**
 *
 * history.js:
